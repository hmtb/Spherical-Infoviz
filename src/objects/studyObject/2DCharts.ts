...
export class Chart2D extends SceneObject {
    ...
    constructor(window: allofw.OpenGLWindow, omni: allofw.IOmniStereo, startTime: number,size:number) {
        ...
        this.chartCarbon = PlanarImage(omni, "studyData/img/Carbon.png");
        ...
        console.log("hier")
        this.chartTemperatur = PlanarImage(omni, "studyData/img/temperatur.png");
