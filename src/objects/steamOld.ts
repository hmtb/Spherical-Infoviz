...
export class PlanetSteamOld extends SceneObject {
    year: any;
    ...
    constructor(window: allofw.OpenGLWindow, omni: allofw.IOmniStereo, data: any, startTime: number, text: boolean) {
        super(omni)
    ...
    public render(): void {
        ...
        this.texts && this.texts.render(this.omni);
