...
// //creat mark and extend the constructor with the values you need
...
//     let cx = size * cos(lon + cubeTime / 2) * cos(lat);
//     let cy = size * sin(lat);
//     let cz = size * sin(lon + cubeTime / 2) * cos(lat);
//     Cube(Vector3(cx, cy, cz), 0.05, Color(1, 0, 0, 1));
